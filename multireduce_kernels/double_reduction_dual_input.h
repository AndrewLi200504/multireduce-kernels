...
template<typename T> __device__ __forceinline__ T dev_bitwise_or(T a, T b) { return a | b; }




template<typename T, typename U, T (*Map0)(T, T), T (*Map1)(T, T), U (*Op0)(U, U), U (*Op1)(U, U)>
__global__ void dual_reduction_kernel(const T* a, const T* b, dual_reduction<U>* blockdrs,
...
template<typename T, typename U, T (*Map0)(T, T), T (*Map1)(T, T), U (*Op0)(U, U), U (*Op1)(U, U)>
void dual_reduction_launcher(const T* data0, const T* data1, U* out0, U* out1, int n,
