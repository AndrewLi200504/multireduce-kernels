template<typename T, typename U, U (*Map0)(U), U (*Map1)(U, U), U (*Map2)(U), U (*Op0)(U, U), U (*Op1)(U, U), U (*Op2)(U, U)>
__global__ void triple_reduction_kernel_mixed_type(const T* a, const T* b, triple_reduction<U>* blocktrs,
                                        int n, U identity0, U identity1, U identity2) {
    int tid = threadIdx.x;
...
void triple_reduction_launcher(const T* data0, const T* data1, U* out0, U* out1, U* out2, int n,
    ...
    triple_reduction_kernel_mixed_type<T, U, Map0, Map1, Map2, Op0, Op1, Op2><<<num_blocks, BLOCK_SIZE>>>(
