...
template<typename T, typename U, U (*Map0)(T, T, T), U (*Map1)(T, T, T), U (*Map2)(T, T, T), 
U (*Op0)(U, U), U (*Op1)(U, U), U (*Op2)(U, U)>
__global__ void triple_reduction_kernel(const T* a, const T b, const T c, const T d, const T e, const T f, const T g, 
    triple_reduction<U>* blocktrs, int n, T identity0, T identity1, T identity2) {
    int tid = threadIdx.x;
    ...
    for (int k = 0; k < STRIDE; k++) {
        ...
        if (currIdx < n) {
            tr.red0 = Op0(tr.red0, Map0(a[currIdx], b, c)); 
            tr.red1 = Op1(tr.red1, Map1(a[currIdx], d, e));
            tr.red2 = Op2(tr.red2, Map2(a[currIdx], f, g));
...
template<typename T, typename U, U (*Map0)(T, T, T), U (*Map1)(T, T, T), U (*Map2)(T, T, T), U (*Op0)(U, U), U (*Op1)(U, U),
U (*Op2)(U, U)>
void triple_reduction_launcher(const T* data, const T b, const T c, const T d, const T e, const T f, const T g, U* out0, 
                            U* out1, U* out2, int n, U identity0, U identity1, U identity2) {
    int current_n = n;
    ...
    triple_reduction_kernel<T, U, Map0, Map1, Map2, Op0, Op1, Op2><<<num_blocks, BLOCK_SIZE>>>(
        data, b, c, d, e, f, g, device_output, current_n, identity0, identity1, identity2);
