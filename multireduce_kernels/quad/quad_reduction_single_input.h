template<typename T, typename U, U (*Map0)(T), U (*Map1)(T), U (*Map2)(T), U (*Map3)(T), U (*Op0)(U, U), U (*Op1)(U, U), U (*Op2)(U, U), U (*Op3) (U, U)>
__global__ void quad_reduction_kernel(const T* a, quad_reduction<U>* blockqrs,
                                        int n, U identity0, U identity1, U identity2, U identity3) {
    int tid = threadIdx.x;
    ...
    for (int k = 0; k < STRIDE; k++) {
        ...
        if (currIdx < n) {
            ...
            qr.red1 = Op1(qr.red1, Map1(a[currIdx])); 
            qr.red2 = Op2(qr.red2, Map2(a[currIdx]));
...
template<typename T, typename U, U (*Map0)(T), U (*Map1)(T), U (*Map2)(T), U (*Map3)(T),
U (*Op0)(U, U), U (*Op1)(U, U), U (*Op2)(U, U), U (*Op3)(U, U)>
void quad_reduction_launcher(const T* data, U* out0, U* out1, U* out2, U* out3, int n,
    ...
    quad_reduction_kernel<T, U, Map0, Map1, Map2, Map3, Op0, Op1, Op2, Op3><<<num_blocks, BLOCK_SIZE>>>(
        data, device_output, current_n, identity0, identity1, identity2, identity3);
